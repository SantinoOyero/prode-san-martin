...
export default async function Home() {
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      {/* ===== Cómo funciona ===== */}
      <section className="border-y border-border bg-sm-cream py-16">
        <div className="mx-auto max-w-5xl px-4">
            ...
            {[
              {
                ...
                bg: 'bg-sm-green',
                title: 'Registrate',
                text: 'Creá tu cuenta con tu email y entrás al prode oficial del club.',
              },
              {
                n: '2',
                bg: 'bg-sm-blue',
                title: 'Predecí',
                text: 'Cargá tu pronóstico de cada partido antes de que arranque.',
              },
              {
                n: '3',
                bg: 'bg-sm-gold-deep',
                title: 'Competí',
                text: 'Sumá puntos, subí en la tabla y peleá los premios.',
              },
            ].map((step) => (
