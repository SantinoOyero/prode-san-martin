...
export default function RegistroPage() {
  ...
  const handleRegister = async (e: React.FormEvent) => {
    ...
    // Si la confirmacion de mail esta desactivada en Supabase, el signUp ya
    // devuelve una sesion: el usuario queda logueado y entra directo al prode.
    if (data.session) {
      router.push('/prode')
      router.refresh()
      return
    ...
    // Fallback: si la confirmacion sigue activa, mostramos el aviso de mail.
    setSuccess(true)
    setLoading(false)
  }
